...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="dashboard_counsellor.php">PES Hostel</a>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          <a href="dashboard_counsellor.php">Dashboard</a>
        </li>
        <li class="breadcrumb-item active">Counsellor</li>
      </ol>
      <div class="card-body">
        <div id="counsellor_table" class="table-responsive">
        </div>
      </div>
    </div>
    <div id="failure" class="alert alert-info">
      <strong>Info!</strong> There seems to be no students with queries, Try again later !
    </div>
    </div>
    <!-- /.container-fluid-->
    ...
    <script src="assets/dashboard/js/counselling.js"></script>
  </div>
</body>
