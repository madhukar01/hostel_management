  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Counselling Dashboard</li>
      </ol>
      <div id="description_form">
        <div class="form-group">
          <label for="counsel">Feeling sad? Talk to us.</label>
          <input class="form-control" id="counsel" name="desc" type="text" aria-describedby="prescriptionHelp" placeholder="Talk to counsellor" required>
          <small id="prescriptionHelp" class="form-text text-muted"></small>
        </div>
        <a class="btn btn-primary" id="submit_button">Submit</a>
      </div>
      <div id="submit_success" class="alert alert-success">
        <strong>Success!</strong> A counsellor will be in touch with you shortly.
      </div>
    ...
    <script src="assets/dashboard/js/counselling_student.js"></script>
  </div>
</body>
